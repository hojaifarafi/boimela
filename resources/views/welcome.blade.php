...
@section('content')
    ...
    <!-- Hero Section start  -->
    <div class="hero-section hero-1 fix bg-cover" style="background-image: url(assets/img/hero/hero-bg-1.jpg);">
        <div class="book-shape float-bob-y">
            <img src="assets/img/hero/book-shape.png" alt="img">
        </div>
        <div class="book-shape-2 float-bob-y">
            <img src="assets/img/hero/book-2.png" alt="img">
        </div>
        <div class="container">
            <div class="row">
                <div class="hero-main-wrapper">
                    <div class="hero-content">
                        <h4 class="wow fadeInUp" data-wow-delay=".2s">editor choice best books <span>Up to 50%
                                Off</span></h4>
                        <h1 class="wow fadeInUp" data-wow-delay=".4s">Your Next Favorite Book <br> Is Just a <span
                                class="line-shape">Click Away <img src="assets/img/hero/line-shape.png"
                                    alt="shape"></span>
                        </h1>
                        <p class="wow fadeInUp" data-wow-delay=".6s">Sed ac arcu sed felis vulputate molestie. Nullam at
                            urna in velit finibus vestibulum euismod
                            A <br>
                            Urna. Sed quis aliquam leo. Duis iaculis lorem mauris, et convallis du</p>
                    </div>
                    <div class="hero-btn">
                        <button type="submit" class="theme-btn wow fadeInUp" data-wow-delay=".8s">
                            Shop Now <i class="fa-solid fa-arrow-right-long"></i>
                        </button>
                        <button type="submit" class="theme-btn style-2 wow fadeInUp" data-wow-delay="1s">
                            view all books <i class="fa-solid fa-arrow-right-long"></i>
                        </button>
                    </div>

                    <div class="girl-img">
                        <img src="assets/img/hero/hero-girl-1.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="shop-section section-padding fix pt-0">
        <div class="container">
            <div class="section-title-area">
                ...
                <a href="shop.html" class="theme-btn style-2 fadeInUp" data-wow-delay=".5s">Explore More <i
    ...
    <section class="book-catagories-section fix section-padding bg-cover"
        style="background-image: url(assets/img/top-categories-bg.jpg);">
        <div class="container">
            <div class="book-catagories-wrapper">
                <div class="section-title text-center">
                    <span class="icon"><img src="assets/img/icon/icon-24.svg" alt="icon"></span>
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                ...
                                <div class="book-content">
                                    <h6><a href="shop-details.html">Castle In The Sky</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                ...
                                <div class="book-content">
                                    <h6><a href="shop-details.html">UX Research</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                ...
                                <div class="book-content">
                                    <h6><a href="shop-details.html">Safe Home</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                ...
                                <div class="book-content">
                                    <h6><a href="shop-details.html">Grow Flower</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                ...
                                <div class="book-content">
                                    <h6><a href="shop-details.html">Unicorn Erna</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="book-shop-wrapper">
                ...
                <div class="cta-shop-box">
                    ...
                    <a href="shop.html" class="theme-btn wow fadeInUp" data-wow-delay=".6s">Shop Now <i
                            class="fa-solid fa-arrow-right-long"></i></a>
        ...
        <div class="container">
            <div class="cta-banner-wrapper section-padding bg-cover"
                ...
                <div class="book-shape">
                    <img src="assets/img/cta-book-2.png" alt="shape-img">
                </div>
                <div class="book-shape-2">
                    <img src="assets/img/cta-book.png" alt="shape-img">
                </div>
                <div class="cta-content text-center">
                    <span class="wow fadeInUp" data-wow-delay=".2s">Get 25% <img src="assets/img/line-shape.png" alt=""></span>
                    <h2 class="mb-40 wow fadeInUp" data-wow-delay=".4s">discount
                        in all <br> kind of
                        super Selling</h2>
                    <a href="shop.html" class="theme-btn wow fadeInUp" data-wow-delay=".6s">Shop Now<i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="top-ratting-book-section fix section-padding bg-cover"
        style="background-image: url(assets/img/ratting-bg.jpg);">
        <div class="container">
